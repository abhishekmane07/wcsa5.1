...
public class ToHandleActiTimeFilePopup {
	public static void main(String[] args) throws InterruptedException, IOException {
			...
			// Launch the ActiTime
			driver.get("http://desktop-stile0o/login.do;jsessionid=73ibq0iw21sg");
			...
			Runtime.getRuntime().exec("./Autoid{rogram/OmayoFile.exe");
